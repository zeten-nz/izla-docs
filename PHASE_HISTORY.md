...
| 2.2C | Methodist CMS web app (`izlan/web`, Next.js) + narrow capability endpoint (no schema; design + i18n uz/ru/en + a11y focus/dnd-kit; +33 Vitest web tests) | PASS | 22 | 474 | 547 | `57530d5` | `phase/2.2C` (SHA in checkpoint/PR) | [2.2C.md](checkpoints/2.2C.md) |
