...
| 2.2C | Methodist CMS web app (`izlan/web`, Next.js) + capability endpoint; design + i18n uz/ru/en; a11y; **TD-252 phone+password auth** (Argon2id `PasswordCredential`, OTP→registration/reset, migration 23); 42 Vitest web tests | PASS | 23 | 479 | 553 | `3e7f524` | `phase/2.2C` (SHA in checkpoint/PR) | [2.2C.md](checkpoints/2.2C.md) |
