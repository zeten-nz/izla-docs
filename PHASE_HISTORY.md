...
| 2.2E | English A1 pilot content v1 — first real content pack (English→General English→A1→A1 Foundations; 4 topics / 12 lessons / 96 activities / 13 skills; markdown+objective only; linear prereq chain; Uzbek teaching / English target). Content files + `content:pilot:a1:validate` + pilot validator, real import/publish/learner/scoring e2e; **no schema/migration, no new TD**. TECHNICAL PASS — pedagogical review pending | PASS(tech) | 23 | 499 | 594 | `44a0bfb` | `phase/2.2E` (SHA in checkpoint/PR) | [2.2E.md](checkpoints/2.2E.md) |
